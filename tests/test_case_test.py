...
class TestStub(TestCase):
    ...
    def test_error(self): raise Exception
...
class TestCaseTest(TestCase):
    ...
    def test_result_multiple_run(self):
        stub = TestStub("test_success"); stub.run(self.result)
        stub = TestStub("test_failure"); stub.run(self.result)
        stub = TestStub("test_error"); stub.run(self.result)
